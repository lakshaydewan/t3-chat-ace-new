...
export default async function SignInPage({ params }: { params: { callbackUrl: string | undefined } }) {
            ...
            <div className="w-full max-w-md">
                ...
                <div className="text-center mt-6">
                    <p className="text-sm text-gray-600">
                        ...
                        <a href="/signup" className="text-rose-500 hover:text-rose-600 font-medium transition-colors duration-200">
                            Sign up here
                        </a>
                    </p>
                </div>
